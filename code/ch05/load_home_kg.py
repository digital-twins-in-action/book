...
conn = mgclient.connect(host="localhost", port=7687, username="user", password="pass")
...
(l:Land {name: '742 Evergreen Terrace'})<-[:isPartOf]-(h:Building {name: 'House', address: '742 Evergreen Terrace'}),
...
(ref)<-[:serves]-(ps4:PowerSensor {name: 'power_meter_4', sensorId: '24e124148e423058', x: 3.54, y: 13.2}),
...
(lr)<-[:serves]-(ts4:TemperatureSensor {name: 'temp_sensor_4', sensorId: '24e124710b423527',  x: 10.77, y: 14.33}),
...
(rt)<-[:serves]-(ls1:PercentSensor {name: 'level_sensor_1', x: 4.52, y: -0.2 });
"""
)
