...
def create_transformation_matrix(origin_easting, origin_northing, rotation_angle_degrees):
    """
...
if __name__ == "__main__":
    ...
    for i in range(len(local_coords)):
        print(f"Local: ({local_coords[i][0]}, {local_coords[i][1]}) → UTM: ({utm_coords[i][0]:.1f}, {utm_coords[i][1]:.1f})")
